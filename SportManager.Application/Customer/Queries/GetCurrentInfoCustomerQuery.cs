...
public record GetCurrentCustomerQuery : IRequest<GetUserResponse> { };


public class GetCurrentCustomerQueryHandler(IReadOnlyApplicationDbContext applicationDbContext, ICurrentUserService currentUserService)
    : IRequestHandler<GetCurrentCustomerQuery, GetUserResponse>
{
    public async Task<GetUserResponse> Handle(GetCurrentCustomerQuery request, CancellationToken cancellationToken)
    {
