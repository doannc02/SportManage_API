...
namespace SportManager.Infrastructure.Migrations
{
    ...
    [Migration("20250613034212_updateOrderEntityForShipping")]
    partial class updateOrderEntityForShipping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportManager.Domain.Entity.Carrier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SportManager.Domain.Entity.Order", b =>
                {
                    ...
                    b.Property<string>("ImageConfirmed")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PackingAddress")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<Guid?>("PackingAddressId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SportManager.Domain.Entity.Shipper", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SportManager.Domain.Entity.ShipperCarrier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SportManager.Domain.Entity.ShippingHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SportManager.Domain.Entity.UserVoucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SportManager.Domain.Entity.Voucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SportManager.Domain.Entity.VoucherUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SportManager.Domain.Entity.Order", b =>
                {
                    b.HasOne("SportManager.Domain.Entity.Carrier", "Carrier")
                        .WithMany("Orders")
                    ...
                    b.HasOne("SportManager.Domain.Entity.Shipper", "Shipper")
                        .WithMany("Orders")
                        .HasForeignKey("ShipperId");

                    b.HasOne("SportManager.Domain.Entity.Voucher", "Voucher")
                        .WithMany()
